...
export function BenefitsGrid() {
  return (
    <section className="section-shell relative overflow-hidden bg-[#f3efe0]">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {benefits.map((item) => {
            ...
            return (
              <article
                key={item.title}
                className="rounded-[2rem] border border-black/10 bg-white/95 p-6 shadow-card transition duration-300 hover:-translate-y-1 hover:shadow-[0_28px_70px_rgba(0,0,0,0.12)]"
              >
